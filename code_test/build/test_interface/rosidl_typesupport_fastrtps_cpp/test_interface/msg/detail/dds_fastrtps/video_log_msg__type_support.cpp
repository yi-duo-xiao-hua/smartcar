...
#include "test_interface/msg/detail/video_log_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const test_interface::msg::ObjectMsg &,
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: obj_list
  {
    ...
    for (size_t i = 0; i < size; i++) {
      test_interface::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.obj_list[i],
        cdr);
    }
  }
  // Member: linear
  ...
  test_interface::msg::VideoLogMsg & ros_message)
{
  ...
  // Member: obj_list
  {
    ...
    ros_message.obj_list.resize(size);
    for (size_t i = 0; i < size; i++) {
      test_interface::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.obj_list[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: obj_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        test_interface::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.obj_list[index], current_alignment);
    }
  }
  // Member: linear
  {
  ...
  size_t current_alignment)
{
  ...
  // Member: obj_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        test_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_ObjectMsg(
  ...
  if (is_plain) {
    ...
    using DataType = test_interface::msg::VideoLogMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const test_interface::msg::VideoLogMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<test_interface::msg::VideoLogMsg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _VideoLogMsg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const test_interface::msg::VideoLogMsg *>(
...
static size_t _VideoLogMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_VideoLogMsg(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _VideoLogMsg__callbacks = {
  "test_interface::msg",
  "VideoLogMsg",
...
static rosidl_message_type_support_t _VideoLogMsg__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_VideoLogMsg__callbacks,
...
{
  return &test_interface::msg::typesupport_fastrtps_cpp::_VideoLogMsg__handle;
}
