...
static const _ObjectMsg_type_support_symbol_names_t _ObjectMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_interface, msg, ObjectMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_interface, msg, ObjectMsg)),
  }
};
...
{
  return &::test_interface::msg::rosidl_typesupport_cpp::ObjectMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, test_interface, msg, ObjectMsg)() {
  return get_message_type_support_handle<test_interface::msg::ObjectMsg>();
}
