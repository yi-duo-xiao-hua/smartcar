...
#include "test_interface/msg/detail/object_msg__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // obj_type
#include "rosidl_runtime_c/string_functions.h"  // obj_type

// forward declare type support functions


using _ObjectMsg__ros_msg_type = test_interface__msg__ObjectMsg;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: obj_type
  {
    const rosidl_runtime_c__String * str = &ros_message->obj_type;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: obj_type
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->obj_type.data) {
      rosidl_runtime_c__String__init(&ros_message->obj_type);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->obj_type,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'obj_type'\n");
      return false;
    }
  }
...
static uint32_t _ObjectMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_test_interface__msg__ObjectMsg(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = test_interface__msg__ObjectMsg;
    is_plain =
      (
...
static size_t _ObjectMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_test_interface__msg__ObjectMsg(
