...
class VideoLoggerV2(Node):
    def __init__(self):
        super().__init__("VideoLoggerNodeV2")
        ...
        print(f"VideoLogger V2 config: {self.params}")
    ...
    def write_frame(self, frame):
        ...
        # 实时显示画面
        cv2.imshow("Real-time Video Log", frame)
        cv2.waitKey(1)
