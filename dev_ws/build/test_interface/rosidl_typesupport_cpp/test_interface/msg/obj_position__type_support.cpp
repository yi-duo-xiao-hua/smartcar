...
static const _ObjPosition_type_support_symbol_names_t _ObjPosition_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_interface, msg, ObjPosition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_interface, msg, ObjPosition)),
  }
};
...
{
  return &::test_interface::msg::rosidl_typesupport_cpp::ObjPosition_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, test_interface, msg, ObjPosition)() {
  return get_message_type_support_handle<test_interface::msg::ObjPosition>();
}
