...
bool origincar_base__msg__position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("origincar_base.msg._position.Position", full_classname_dest, 37) == 0);
  }
  origincar_base__msg__Position * ros_message = _ros_message;
  {  // angle_x
...
PyObject * origincar_base__msg__position__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("origincar_base.msg._position");
