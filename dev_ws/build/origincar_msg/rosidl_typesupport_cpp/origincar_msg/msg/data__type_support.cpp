...
static const _Data_type_support_symbol_names_t _Data_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, origincar_msg, msg, Data)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, origincar_msg, msg, Data)),
  }
};
...
{
  return &::origincar_msg::msg::rosidl_typesupport_cpp::Data_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, origincar_msg, msg, Data)() {
  return get_message_type_support_handle<origincar_msg::msg::Data>();
}
