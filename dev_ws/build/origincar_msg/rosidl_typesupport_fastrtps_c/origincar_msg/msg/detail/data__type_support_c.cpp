...
#include "origincar_msg/msg/detail/data__rosidl_typesupport_fastrtps_c.h"
...
using _Data__ros_msg_type = origincar_msg__msg__Data;
...
size_t get_serialized_size_origincar_msg__msg__Data(
  const void * untyped_ros_message,
...
static uint32_t _Data__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_origincar_msg__msg__Data(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_origincar_msg
size_t max_serialized_size_origincar_msg__msg__Data(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = origincar_msg__msg__Data;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
static size_t _Data__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_origincar_msg__msg__Data(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, origincar_msg, msg, Data)() {
